...
public class AllPurchaseCourseAdapter extends RecyclerView.Adapter<AllPurchaseCourseAdapter.ViewHolder> {
    private Context context;
    private List<CourseContentArray> list1;

    public AllPurchaseCourseAdapter(Context context, List<CourseContentArray> horizontalList){
