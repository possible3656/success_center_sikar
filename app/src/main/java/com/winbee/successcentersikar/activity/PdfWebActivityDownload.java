...
public class PdfWebActivityDownload extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebsiteHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PdfWebActivityDownload.this,MainActivity.class);
        ...
        img_noti.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PdfWebActivityDownload.this,NotificationActivity.class);
                startActivity(intent);
            }
        });
      ...
      //  String url = "https://docs.google.com/viewer?embedded = true&url = "+myPdfUrl;
        ...
        web_view.setDownloadListener(new  DownloadListener() {
            public void onDownloadStart (String url, String userAgent,
                ...
                Toast.makeText(PdfWebActivityDownload.this, "File is Downloading...", Toast.LENGTH_SHORT).show();
            }
