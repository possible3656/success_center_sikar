...
import com.winbee.successcentersikar.adapter.QuizSolutionAdapter;
...
public class QuizSolutionActivity extends AppCompatActivity {
    ...
    String Referal_code;
    ImageView submit_solution,WebsiteHome,img_share,select_image,select_url,img_noti;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout_user.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent profile = new Intent(QuizSolutionActivity.this, DashboardCourseActivity.class);
        ...
        img_noti.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent profile = new Intent(QuizSolutionActivity.this, NotificationActivity.class);
                startActivity(profile);
            }
        });
        ...
        layout_test_series.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent test = new Intent(QuizSolutionActivity.this, SubjectActivity.class);
                startActivity(test);
        ...
        layout_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent profile = new Intent(QuizSolutionActivity.this,MainActivity.class);
                startActivity(profile);
            }
        });
        ...
        layout_doubt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent profile = new Intent(QuizSolutionActivity.this, DoubtActivity.class);
                startActivity(profile);
            }
        });
        ...
        layout_notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent profile = new Intent(QuizSolutionActivity.this,ReferalActivity.class);
                startActivity(profile);
            }
        });
        WebsiteHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(QuizSolutionActivity.this, DiscussionActivity.class);
    ...
    private void callAskedSolutionApiService(){
        ...
        Call<ArrayList<SolutionQuestion>> call = apiCall.getQuizSolution(LocalData.FileName);
        ...
        call.enqueue(new Callback<ArrayList<SolutionQuestion>>() {
            ...
            public void onResponse(Call<ArrayList<SolutionQuestion>> call, Response<ArrayList<SolutionQuestion>> response) {
                ...
                if(statusCode==200){
                    ...
                    list = response.body();
                    adapter = new QuizSolutionAdapter(QuizSolutionActivity.this,list);
    ...
    private void callSolutionApiService(SolutionDoubtQuestion solutionDoubtQuestion) {
        ...
        ClientApi apiCall = ApiClient.getClient().create(ClientApi.class);
        Call<SolutionDoubtQuestion> call = apiCall.getQuizSolutionText(solutionDoubtQuestion.getUserid(),solutionDoubtQuestion.getFilename(),solutionDoubtQuestion.getAnswer(),"1");
        ...
        call.enqueue(new Callback<SolutionDoubtQuestion>() {
            ...
            public void onResponse(Call<SolutionDoubtQuestion> call, Response<SolutionDoubtQuestion> response) {
                ...
                if (statusCode == 200 && response.body() != null) {
                    progressBarUtil.hideProgress();
                    startActivity(new Intent(QuizSolutionActivity.this, QuizSolutionActivity.class));
                    finish();
                } else {
...
//
        if (requestCode == IMG_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            try {
                ...
                final Dialog dialog = new Dialog(QuizSolutionActivity.this);
    ...
    private void callSolutionImageApiService(SolutionDoubtQuestion solutionDoubtQuestion) {
        ...
        // final UrlQuestionSolution urlQuestionSolution = new UrlQuestionSolution(solution, question,userid, documentid);
        ClientApi apiCall = ApiClient.getClient().create(ClientApi.class);
        Call<SolutionDoubtQuestion> call = apiCall.getQuizSolutionImage(solutionDoubtQuestion.getUserid(),solutionDoubtQuestion.getFilename(),solutionDoubtQuestion.getAnswer(),"2");
        Log.d("tag", "callSolutionApiService: "+solutionDoubtQuestion.getFilename()+solutionDoubtQuestion.getAnswer()+solutionDoubtQuestion.getUserid());
        call.enqueue(new Callback<SolutionDoubtQuestion>() {
            @Override
            public void onResponse(Call<SolutionDoubtQuestion> call, Response<SolutionDoubtQuestion> response) {
                ...
                if (statusCode == 200 && response.body() != null) {
                    progressBarUtil.hideProgress();
                    Toast.makeText(QuizSolutionActivity.this, "image uploaded", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(QuizSolutionActivity.this, QuizSolutionActivity.class));
                    finish();
                } else {
                    System.out.println("Sur: response code" + response.message());
