...
public class MyPurchaseSubjectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_noti.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MyPurchaseSubjectActivity.this,NotificationActivity.class);
                startActivity(intent);
            }
        });
        ...
        layout_notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent profile = new Intent(MyPurchaseSubjectActivity.this,ReferalActivity.class);
                startActivity(profile);
            }
        });
