...
import com.winbee.successcentersikar.adapter.AllTopicAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebsiteHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CourseTopicActivity.this, MainActivity.class);
        ...
        img_noti.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CourseTopicActivity.this,NotificationActivity.class);
                startActivity(intent);
            }
        });
        ...
        layout_user.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent profile = new Intent(CourseTopicActivity.this,DashboardCourseActivity.class);
        ...
        layout_test_series.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent test = new Intent(CourseTopicActivity.this, SubjectActivity.class);
                startActivity(test);
        ...
        layout_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent profile = new Intent(CourseTopicActivity.this,MainActivity.class);
                startActivity(profile);
            }
        });
        ...
        layout_doubt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent profile = new Intent(CourseTopicActivity.this,DiscussionActivity.class);
                startActivity(profile);
            }
        });
        ...
        layout_notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent profile = new Intent(CourseTopicActivity.this, ReferalActivity.class);
                startActivity(profile);
            }
        });
                ...
                if(statusCode==200){
                    if (response.body().getError()==false) {
                        ...
                        if (list.size()!=0) {
                            ...
                            adapter = new AllTopicAdapter(CourseTopicActivity.this, list);
                        ...
                        android.app.AlertDialog.Builder alertDialogBuilder =
                                new android.app.AlertDialog.Builder(CourseTopicActivity.this);
        ...
        call.enqueue(new Callback<LogOut>() {
            ...
            public void onResponse(Call<LogOut> call, Response<LogOut> response) {
                ...
                if (statusCode == 200 && response.body().getLoginStatus()!=false) {
                    if (response.body().getError()==false){
                        progressBarUtil.hideProgress();
                        SharedPrefManager.getInstance(CourseTopicActivity.this).logout();
                        startActivity(new Intent(CourseTopicActivity.this, LoginActivity.class));
                        finish();
                    }else{
                        android.app.AlertDialog.Builder alertDialogBuilder = new android.app.AlertDialog.Builder(
                                CourseTopicActivity.this);
                        alertDialogBuilder.setTitle("Alert");
                        alertDialogBuilder
                                .setMessage(response.body().getError_Message())
                                .setCancelable(false)
                    ...
                    progressBarUtil.hideProgress();
                    Toast.makeText(CourseTopicActivity.this, response.body().getMessageFailure(), Toast.LENGTH_LONG).show();
                }
            ...
            public void onFailure(Call<LogOut> call, Throwable t) {
                Toast.makeText(CourseTopicActivity.this, "Failed" + t.getMessage(), Toast.LENGTH_LONG).show();
