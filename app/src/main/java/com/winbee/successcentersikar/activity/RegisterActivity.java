...
public class RegisterActivity extends AppCompatActivity {
    ...
    EditText editTextname, editTextEmail, editTextPassword,editTextPhone,editTextRePassword,editTextreferal;
    Button register;
    ...
    private void userValidation() {
        ...
        referal_code = editTextreferal.getText().toString().trim();
        ...
        refUser.setReferralCode(referal_code);
    ...
    private void CallSignupApi(final RefUser refUser) {
       ...
       ClientApi mService = ApiClient.getClient().create(ClientApi.class);
        Call<RefUser> call = mService.refUserSignIn(2, refUser.getName(),refUser.getEmail(),refUser.getMobile(),"SCS001",
                refUser.getPassword(),android_id,refUser.getReferralCode());
        call.enqueue(new Callback<RefUser>() {
            ...
            public void onResponse(Call<RefUser> call, Response<RefUser> response) {
                ...
                if (statusCode == 200 && response.body().getSuccess()) {
                    if (response.body().getReferredStatus()) {
                        progressBarUtil.hideProgress();
                        Toast.makeText(RegisterActivity.this, response.body().getReferredMessage(), Toast.LENGTH_LONG).show();
                    }else{
                        progressBarUtil.hideProgress();
                        Toast.makeText(RegisterActivity.this, response.body().getReferredMessage(), Toast.LENGTH_LONG).show();
                    }
