...
import com.winbee.successcentersikar.adapter.SubjectAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            img_noti.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(SubjectActivity.this, NotificationActivity.class);
                    startActivity(intent);
                }
            });
            ...
            layout_user.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent profile = new Intent(SubjectActivity.this, DashboardCourseActivity.class);
...
//                @Override
//                public void onClick(View view) {
//                    Intent test = new Intent(SubjectActivity.this,SubjectActivity.class);
//                    startActivity(test);
...
//            });
            ...
            layout_home.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent profile = new Intent(SubjectActivity.this,MainActivity.class);
                    startActivity(profile);
                }
            });
            ...
            layout_doubt.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent profile = new Intent(SubjectActivity.this, DiscussionActivity.class);
                    startActivity(profile);
                }
            });
            ...
            layout_notification.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent profile = new Intent(SubjectActivity.this, NotificationActivity.class);
                    startActivity(profile);
                }
            });
            iniIDs();
            ...
            public void onResponse(Call<SectionDetailsMainModel> call, Response<SectionDetailsMainModel> response) {
                ...
                if(sectionDetailsMainModel!=null){
                    if (sectionDetailsMainModel.getMessage().equalsIgnoreCase("TRUE")){
                        ...
                        subjectAdapter=new SubjectAdapter(SubjectActivity.this,list);
