...
public class MyPurchaseTopicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_noti.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MyPurchaseTopicActivity.this,NotificationActivity.class);
                startActivity(intent);
            }
        });
        ...
        layout_notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent profile = new Intent(MyPurchaseTopicActivity.this,ReferalActivity.class);
                startActivity(profile);
            }
        });
