    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            img_noti.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(AllPurchasedTestActivity.this, NotificationActivity.class);
                    startActivity(intent);
                }
            });
            ...
            layout_notification.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent profile = new Intent(AllPurchasedTestActivity.this, ReferalActivity.class);
                    startActivity(profile);
                }
            });
            iniIDs();
