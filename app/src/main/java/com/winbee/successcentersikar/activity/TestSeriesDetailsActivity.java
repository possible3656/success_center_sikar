...
public class TestSeriesDetailsActivity extends AppCompatActivity
        implements  NavigationView.OnNavigationItemSelectedListener, PaymentResultWithDataListener
    {
        ...
        private ImageView img_share,WebsiteHome,img_noti,image_expand_more,image_expand_less,
        ...
        go_back_failed.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent  =new Intent(TestSeriesDetailsActivity.this, NotificationActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        public boolean onNavigationItemSelected(MenuItem item) {
            ...
            startActivity(txn);
                ...
                Intent intent = new Intent(TestSeriesDetailsActivity.this, ReferalActivity.class);
                startActivity(intent);
