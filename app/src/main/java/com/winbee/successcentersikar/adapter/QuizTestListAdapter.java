...
public class QuizTestListAdapter extends RecyclerView.Adapter<QuizTestListAdapter.CustomViewHolder> {
    private Context context;
    private List<SIACDetailsDataModel> siacDetailsDataModelList;
    private View view;

    public QuizTestListAdapter(Context context, List<SIACDetailsDataModel> siacDetailsDataModelList) {
