    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            img_noti.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(OnlineTestActivity.this,NotificationActivity.class);
                    startActivity(intent);
                }
            });
            ...
            layout_user.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent profile = new Intent(OnlineTestActivity.this, DashboardCourseActivity.class);
            ...
            layout_test_series.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent test = new Intent(OnlineTestActivity.this, SubjectActivity.class);
                    startActivity(test);
            ...
            layout_home.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent profile = new Intent(OnlineTestActivity.this,MainActivity.class);
                    startActivity(profile);
                }
            });
            ...
            layout_doubt.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent profile = new Intent(OnlineTestActivity.this, DiscussionActivity.class);
                    startActivity(profile);
                }
            });
            ...
            layout_notification.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent profile = new Intent(OnlineTestActivity.this,ReferalActivity.class);
                    startActivity(profile);
                }
            });
            iniIDs();
