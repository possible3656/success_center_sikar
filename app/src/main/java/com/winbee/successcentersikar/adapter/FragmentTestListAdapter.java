...
public class FragmentTestListAdapter extends RecyclerView.Adapter<FragmentTestListAdapter.CustomViewHolder> {
    private Context context;
    private List<SIACDetailsDataModel> siacDetailsDataModelList;
    private View view;

    public FragmentTestListAdapter(Context context, List<SIACDetailsDataModel> siacDetailsDataModelList) {
