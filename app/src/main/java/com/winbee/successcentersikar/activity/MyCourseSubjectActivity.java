...
import com.winbee.successcentersikar.adapter.AllSubjectAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebsiteHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MyCourseSubjectActivity.this,MainActivity.class);
        ...
        img_noti.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MyCourseSubjectActivity.this,NotificationActivity.class);
                startActivity(intent);
            }
        });
        ...
        layout_user.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent profile = new Intent(MyCourseSubjectActivity.this, DashboardCourseActivity.class);
        ...
        layout_test_series.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent test = new Intent(MyCourseSubjectActivity.this, SubjectActivity.class);
                startActivity(test);
        ...
        layout_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent profile = new Intent(MyCourseSubjectActivity.this,MainActivity.class);
                startActivity(profile);
            }
        });
        ...
        layout_doubt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent profile = new Intent(MyCourseSubjectActivity.this, DiscussionActivity.class);
                startActivity(profile);
            }
        });
        ...
        layout_notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent profile = new Intent(MyCourseSubjectActivity.this,ReferalActivity.class);
                startActivity(profile);
            }
        });
                ...
                if(statusCode==200){
                    if (response.body().getError()==false) {
                        ...
                        if (list.size()!=0){
                            ...
                            adapter = new AllSubjectAdapter(MyCourseSubjectActivity.this, list);
                        ...
                        android.app.AlertDialog.Builder alertDialogBuilder =
                                new android.app.AlertDialog.Builder(MyCourseSubjectActivity.this);
