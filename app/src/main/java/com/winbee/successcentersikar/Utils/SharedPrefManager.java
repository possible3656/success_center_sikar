...
public class SharedPrefManager {
    ...
    public void userLogin(RefCode refCode) {
        ...
        editor.putString(KEY_REFERAL_CODE, refCode.getREFERRAL_CODE());
        editor.apply();
    }
    ...
    public RefCode refCode() {
        ...
        return new RefCode(
                ...
                sharedPreferences.getString(KEY_REFERAL_CODE, null)
        ...
        public RefUser refUser1() {
            ...
            return new RefUser(
                    ...
                    sharedPreferences1.getString(KEY_REFERAL_CODE1, null)
