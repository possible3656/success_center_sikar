...
public class AllPurchasedPdfSellAdapter extends RecyclerView.Adapter<AllPurchasedPdfSellAdapter.ViewHolder> {
    private Context context;
    private List<PdfSellArray> list1;

    public AllPurchasedPdfSellAdapter(Context context, List<PdfSellArray> horizontalList){
