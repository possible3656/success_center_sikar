  ...
  Button btn_courses;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_noti.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DashboardCourseActivity.this,NotificationActivity.class);
                startActivity(intent);
                finish();
            }
        });
...
//        });
        ...
        layout_notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent profile = new Intent(DashboardCourseActivity.this, ReferalActivity.class);
                startActivity(profile);
            }
        });
